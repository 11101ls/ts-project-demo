...
/*
  安装eslint
*/
export function installESlint(): any {
  shell.exec(
    'npm i eslint @typescript-eslint/parser @typescript-eslint/eslint-plugins -D',
  );
  // 添加 .eslintrc.js
...
/*
  安装Prettier
*/
export function installPrettier(): any {
...
*/
export function installBuild(feature: Array<string>): any {
  // package.json 设置
  const packageJson = readJsonFile<PackageJSON>('./package.json');
